...
.portfolio__button--animated.button--presentation:hover { width: 9rem; }
...
.portfolio__buttons:not(.presentation-hover) .portfolio__button--animated:nth-child(4) .button__text {
...
.portfolio__buttons:not(.presentation-hover) .portfolio__button--animated:nth-child(4) .button__arrow {
...
.button--figma, .button--github, .button--presentation, .button--demo {
  color: white;
